			...
			<div class="col-md-6">
				<div id="formulario">
				    ...
				    <div class="col-xs-7">
				   	...
				   	<br>
				  	<div class="form-group">
				    	<label style="color:white;" for="ejemplo_password_3" class="col-lg-2 control-label">Rol</label>
				    	<div class="col-xs-7">
				     		<input type="text" class="form-control" name="rol" id="ejemplo_password_3"placeholder="Rol del alumno" required="true">
